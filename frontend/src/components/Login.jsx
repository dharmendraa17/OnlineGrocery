...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      // send the form data object (name, email, password)
      console.log("Submitting auth form:", state, formData);
    ...
    >
      ...
      >
        ...
        >
          ...
          <a href="#" className="text-primary hover:underline to-primary-dull cursor-pointer">
            click here
          </a>
        </p>
      </form>
