...
export default function Footer() {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full bg-primary/10">
      <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">
        <div className="max-w-96">
          <img className="w-34 md:w-32" src={assets.logo} alt="logo" />
          <p className="mt-6 text-lg text-gray-500">
            Your go-to online grocery store for fresh, organic, and locally
            sourced produce delivered straight to your doorstep.
          </p>
        ...
        <div className="w-1/2 flex flex-wrap md:flex-nowrap justify-between">
          ...
          <div>
            <h2 className="font-semibold text-gray-900 mb-5">Need help?</h2>
      ...
      <p className="py-4 text-center text-xs md:text-sm text-gray-500/80">
        Copyright {new Date().getFullYear()} © <a href="/">D-Tech Solution</a>. All
        Right Reserved.
      </p>
    </footer>
  );
